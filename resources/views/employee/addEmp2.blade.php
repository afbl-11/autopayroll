...
<head>
    ...
    @vite(['resources/css/employee admin_dashboard registration/addEmp2.css', 'resources/js/app.js'])
</head>
<body>
@include('partitions.sidebar', ['step' => 2])
<div class="container">
    <div class="header"><a href=""><img src="{{ asset('images/left-arrow.png') }}"></a>
        <h2>Add Employee</h2></div>
    @include('partitions.steps')
    <form class="form" action="{{route('employee.register.3')}}" method="get">
        <div class="content">
            ...
            <div class="row">
                <div class="personalContactNum formGroup">
                    ...
                    <input type="number" id="personalContactNum" name="personalContactNum"
                           placeholder="Personal Contact Number" required/>
                </div>
            ...
            <div class="otherContactNum formGroup">
                ...
                <input type="number" id="otherContactNum" name="otherContactNum"
