...
<section class="main-content">
    <div class="form-wrapper">
        <form  action="{{route('store.employee.register.3')}}" method="post" enctype="multipart/form-data">
            @csrf
{{--            employment type (moved above company)--}}
            <div class="field-row">
...
{{--                company and add company button (hidden for part-time)--}}
            <div class="field-row" id="company-field">
                <x-form-select  name="company_id" id="company_id" label="Company" :options="$companies"></x-form-select>
...
{{--            Days Available (only for part-time)--}}
            <div class="field-row days-available-field" id="days-available-field" style="display: none;">
                <div class="days-container">
                    ...
                    <input type="hidden" name="days_available" id="days_available" value="">
                </div>
            </div>
