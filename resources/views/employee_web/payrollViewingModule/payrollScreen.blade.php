                ...
                <div class="card-body p-4">
                    <form action="" method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            <button type="submit" class="button-ghost px-4 fw-bold">
                                <i class="bi bi-funnel"></i>
                            </button>
                            
                            <a href="#" class="btn btn-light border px-3 d-flex align-items-center justify-content-center" title="Reset">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <button class="btn btn-icon btn-light me-1" title="View Details">
                                            <i class="bi bi-eye text-primary"></i>
                                        </button>
                                        <button class="btn btn-icon btn-light" title="Download PDF">
