...
<div class="container">
    ...
    <div class="notifications">
        ...
        <div class="notificationContent">
            <p id="notifContent">{{$variable}}</p>
            <!-- In the design, variable here is "Dear Team, We would like to inform you that starting July 1, 2025, several updates to our company policies will take effect. These changes are part of our ongoing efforts to improve workplace transparency, employee admin_dashboard well-being, and operational efficiency." -->
        </div>
        <div class="rightSide">
            <div class="notifDate">
